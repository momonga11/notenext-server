...
ActiveRecord::Schema.define(version: 20_210_102_072_553) do
  ...
  create_table 'folders', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                          force: :cascade do |t|
  ...
  create_table 'notes', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci',
                        force: :cascade do |t|
    t.bigint 'project_id', null: false
  ...
  create_table 'users_projects', primary_key: %w[user_id project_id],
                                 options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci', force: :cascade do |t|
